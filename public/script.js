...
function back(){
    ...
    document.getElementById('header').innerHTML = '<i class="bi bi-person"></i> Вход или Регистрация'
}
...
function login(){
    ...
    $.ajax({
        ...
        success: function(data){
            if(data == 1){
                alert('Авторизация удалась! (Вставьте сюда код редиректа).')
            } else {
...
function reg(){
    ...
    $.ajax({
        ...
        success: function(data){
            if(data == 1){
                alert('Регистрация удалась! (Вставьте сюда код редиректа).')
            } else {
                if(pass1 != pass2){
                    document.getElementById('lable').innerHTML = 'Пароли не совпадают!'
